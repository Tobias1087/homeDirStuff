...
fun SetupVAM()
    ...
    call vam#ActivateAddons(['Solarized','vim-latex' ,'blackboard', 'desert256', 'molokai', 'wombat256', 'Railscasts_Theme_GUI256color', 'xoria256', 'Syntastic', 'javacomplete', 'project.tar.gz','AutoTag','The_NERD_tree', 'taglist', 'FuzzyFinder', 'endwise', 'surround', 'pep82914', 'rails', 'bundler', 'SuperTab', 'TaskList', 'pydoc910', 'rvm', 'snipmate-snippets', 'vcscommand'], {'auto_install' : 0})
    " 
endf
call SetupVAM()
